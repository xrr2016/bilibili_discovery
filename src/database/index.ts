...
export { WatchHistoryRepository } from './repositories/watch-history-repository.js';
...
export { WatchHistoryQueryService } from './query-server/query/watch-history-query-service.js';
